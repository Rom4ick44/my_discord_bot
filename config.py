...
VACATION_ROLE_ID = 1469703867418542314   # ID роли, выдаваемой в отпуске
CURATOR_ROLE_ID = 1453817087272157305   # ID роли куратора
...
# ID кастомных эмодзи (замените на свои)
EMOJI_ACCEPT = 1479863953734766743   # эмодзи для кнопки "Принять"
EMOJI_REJECT = 1479863818573316136   # эмодзи для кнопки "Отклонить"
EMOJI_CALL = 1479863915721785456     # эмодзи для кнопки "Вызвать на обзвон"
...
VOICE_CHANNEL_ID = 1472308376045228275                     # голосовой канал для обзвона
